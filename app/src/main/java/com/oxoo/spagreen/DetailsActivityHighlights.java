...
import com.oxoo.spagreen.adapters.HomePageAdapterHighlights;
...
public class DetailsActivityHighlights extends AppCompatActivity implements CastPlayer.SessionAvailabilityListener, ProgramAdapter.OnProgramClickListener, EpisodeAdapter.OnTVSeriesEpisodeItemClickListener,
        RelatedTvAdapter.RelatedTvClickListener {
    private static final int PERMISSION_REQUEST_CODE = 1;
    private static final int PRELOAD_TIME_S = 20;
    public static final String TAG = DetailsActivityHighlights.class.getSimpleName();
    ...
    private HomePageAdapterHighlights relatedAdapter;
...
//    private CommentsAdapter commentsAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_details_highlights);

        db = new DatabaseHelper(DetailsActivityHighlights.this);
       ...
       mFirebaseAnalytics = FirebaseAnalytics.getInstance(this);
        ...
        if (PreferenceUtils.isLoggedIn(DetailsActivityHighlights.this)) {
...
//        getComments();
        ...
        imgSubtitle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showSubtitleDialog(DetailsActivityHighlights.this, listSub);
            }
        });
        btnComment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!PreferenceUtils.isLoggedIn(DetailsActivityHighlights.this)) {
                    startActivity(new Intent(DetailsActivityHighlights.this, LoginActivity.class));
                    new ToastMsg(DetailsActivityHighlights.this).toastIconError(getString(R.string.login_first));
                } else if (etComment.getText().toString().equals("")) {
                    new ToastMsg(DetailsActivityHighlights.this).toastIconError(getString(R.string.comment_empty));
                } else {
                    String comment = etComment.getText().toString();
                    addComment( id, PreferenceUtils.getUserId(DetailsActivityHighlights.this), comment);
                }
            }
        });
        ...
        if (!isNetworkAvailable()) {
            new ToastMsg(DetailsActivityHighlights.this).toastIconError(getString(R.string.no_internet));
        }
        ...
        watchNowBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!listServer.isEmpty()) {
                    ...
                    Toast.makeText(DetailsActivityHighlights.this, R.string.no_video_found, Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        downloadBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!listInternalDownload.isEmpty() || !listExternalDownload.isEmpty()) {
                    if (PreferenceUtils.isLoggedIn(DetailsActivityHighlights.this) && PreferenceUtils.isActivePlan(DetailsActivityHighlights.this)) {
...
//                        Log.e("Download", "not permitted");
                    ...
                    Toast.makeText(DetailsActivityHighlights.this, R.string.no_download_server_found, Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        watchLiveTv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                hideExoControlForTv();
                initMoviePlayer(mediaUrl, serverType, DetailsActivityHighlights.this);
        ...
        shareIv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Tools.share(DetailsActivityHighlights.this, title);
            }
        });
        ...
        shareIv2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (title == null) {
                    new ToastMsg(DetailsActivityHighlights.this).toastIconError("Title should not be empty.");
                    return;
                }
                Tools.share(DetailsActivityHighlights.this, title);
            }
        ...
        subscribeBt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (userId == null) {
                    new ToastMsg(DetailsActivityHighlights.this).toastIconError(getResources().getString(R.string.subscribe_error));
                    startActivity(new Intent(DetailsActivityHighlights.this, LoginActivity.class));
                    finish();
                } else {
                    startActivity(new Intent(DetailsActivityHighlights.this, PurchasePlanActivity.class));
                }
    ...
    public void setPlayerNormalScreen() {
        ...
        if (webView.getVisibility() == VISIBLE){
            if (webView != null){
                Intent intent = new Intent(DetailsActivityHighlights.this, DetailsActivityHighlights.class);
    ...
    public void preparePlayer(CommonModels obj){
        ...
        if (!castSession) {
            initMoviePlayer(obj.getStremURL(), obj.getServerType(), DetailsActivityHighlights.this);
            ...
            if (obj.getServerType().toLowerCase().equals("embed")) {
                ...
                showQueuePopup(DetailsActivityHighlights.this, null, getMediaInfo());
            }
        }
    }
    ...
    public void onProgramClick(Program program) {
        if (program.getProgramStatus().equals("onaired")) {
            ...
            new ToastMsg(DetailsActivityHighlights.this).toastIconError("Not Yet");
        }
    }
    ...
    public void onEpisodeItemClickTvSeries(String type, View view, EpiModel obj, int position, EpisodeAdapter.OriginalViewHolder holder) {
        if (type.equalsIgnoreCase("embed")){
            ...
            if (obj != null){
                ...
                initMoviePlayer(obj.getStreamURL(), obj.getServerType(), DetailsActivityHighlights.this);
            }
        }
    }
    ...
    private void loadAd() {
        ...
        if (adsConfig.getAdsEnable().equals("1")) {
            ...
            if (adsConfig.getMobileAdsNetwork().equalsIgnoreCase(Constants.ADMOB)) {
                ...
                BannerAds.showStartAppBanner(DetailsActivityHighlights.this, adView);
                PopUpAds.showStartappInterstitialAds(DetailsActivityHighlights.this);

            } else if (adsConfig.getMobileAdsNetwork().equalsIgnoreCase(Constants.NETWORK_AUDIENCE)) {
                BannerAds.showFANBanner(this, adView);
                PopUpAds.showFANInterstitialAds(DetailsActivityHighlights.this);
            }
    ...
    private void initGetData() {
        if (!type.equals("tv")) {
            ...
            //----related rv----------
            relatedAdapter = new HomePageAdapterHighlights(this, listRelated);
            ...
            if (!PreferenceUtils.isProgramGuideEnabled(DetailsActivityHighlights.this)) {
            ...
            relatedTvAdapter = new RelatedTvAdapter(listRelated, DetailsActivityHighlights.this);
            ...
            relatedTvAdapter.setListener(DetailsActivityHighlights.this);
            ...
            public void onResponse(Call<FavoriteModel> call, retrofit2.Response<FavoriteModel> response) {
                if (response.code() == 200){
                    if (response.body().getStatus().equalsIgnoreCase("success")){
                        new ToastMsg(DetailsActivityHighlights.this).toastIconSuccess(response.body().getMessage());
                        isFav = true;
                        imgAddFav.setBackgroundResource(R.drawable.ic_favorite_white);
                    } else {
                        new ToastMsg(DetailsActivityHighlights.this).toastIconError(response.body().getMessage());
                    }
                }else {
                    new ToastMsg(DetailsActivityHighlights.this).toastIconError(getString(R.string.error_toast));
                }
            }
    ...
    private void paidControl(String isPaid) {
        if (isPaid.equals("1")) {
            if (PreferenceUtils.isLoggedIn(DetailsActivityHighlights.this)) {
                if (PreferenceUtils.isActivePlan(DetailsActivityHighlights.this)) {
                    if (PreferenceUtils.isValid(DetailsActivityHighlights.this)) {
                        contentDetails.setVisibility(VISIBLE);
                        subscriptionLayout.setVisibility(GONE);
                        Log.e("SUBCHECK", "validity: " + PreferenceUtils.isValid(DetailsActivityHighlights.this));

                    } else {
                        Log.e("SUBCHECK", "not valid");
                        /*contentDetails.setVisibility(GONE);
                        subscriptionLayout.setVisibility(VISIBLE);*/
                        PreferenceUtils.updateSubscriptionStatus(DetailsActivityHighlights.this);
                        //paidControl(isPaid);
                    }
                } else {
                ...
                startActivity(new Intent(DetailsActivityHighlights.this, FirebaseSignUpActivity.class));
                finish();
            }
    ...
    public void setSeasonData(List<String> seasonData) {
        ...
        seasonSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                rvServer.setLayoutManager(new LinearLayoutManager(DetailsActivityHighlights.this,
                        RecyclerView.HORIZONTAL, false));
                EpisodeAdapter episodeAdapter = new EpisodeAdapter(DetailsActivityHighlights.this,
                        listServer.get(i).getListEpi());
                rvServer.setAdapter(episodeAdapter);
                episodeAdapter.setOnEmbedItemClickListener(DetailsActivityHighlights.this);
...
//                    editor1.commit();
    ...
    private void removeFromFav() {
        ...
        call.enqueue(new Callback<FavoriteModel>() {
            ...
            @Override
            public void onFailure(Call<FavoriteModel> call, Throwable t) {
                new ToastMsg(DetailsActivityHighlights.this).toastIconError(getString(R.string.fetch_error));
            }
        });
    }
...
//    }
        ...
        switch (requestCode) {
            case PERMISSION_REQUEST_CODE:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    new ToastMsg(DetailsActivityHighlights.this).toastIconSuccess("Now You can download.");
    ...
    public void downloadFile(String url) {
        ...
        String path = Constants.getDownloadDir(DetailsActivityHighlights.this);
        ...
        if (file.exists()) {
            new ToastMsg(DetailsActivityHighlights.this).toastIconError(getString(R.string.file_already_downloaded));
            return;
        }
