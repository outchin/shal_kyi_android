...
public class HighlightsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_highlights, null);
    }
...
//            searchIv.setImageDrawable(activity.getResources().getDrawable(R.drawable.ic_search_white));
    ...
    private void initComponent(View view) {
       ...
       // searchIv = view.findViewById(R.id.search_iv);
        ...
        //the following is default and upper is fixed by zws
...
//        });
    ...
    private void getData(int pageNum) {
        ...
        Call<List<Video>> call = api.getHighlights(Config.API_KEY, pageNum);
